...
with open("2020-02-06.txt", 'r') as f:
    lines = f.readlines()
    for line in lines:
...
while(True):
    ...
    try:  #try loading page with data
        #print("Fetching data")
        reqSlussen = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=2e00260b02a748f99438dfca44e3a4dd&siteid=9192&timewindow=4')
        ...
        reqNytorgsgatan = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=1327&timewindow=4')
        reqÅsögatan = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=1308&timewindow=4')
        reqGotlandsgatan = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=1312&timewindow=4')
        reqSödermannagatan = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=1311&timewindow=4')
        reqSkanstull = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=9190&timewindow=4')
        reqEriksdal = urllib.request.urlopen('https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=1352&timewindow=4')
        reqRosenlund = urllib.request.urlopen(
            'https://api.sl.se/api2/realtimedeparturesV4.xml?key=540b26d4e7bf4b8bbcf9a808c357dcbc&siteid=1351&timewindow=4')
    ...
    for req in requests:  #traverse requests
        ...
        for bus in xml.findAll('Bus'):
            ...
            if dispTemp == "Nu" and tempDest == "Södersjukhuset" and tempLine == "3":  #control that it's a bus on bus line 3
                ...
                if not exists:
                    if station == "Slussen":
                        jlist = [journey, edt, delay, "3000", "3000", "3000", "3000", "3000", "3000", "3000", "3000"]
